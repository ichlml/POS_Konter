...
class m_barang extends CI_Model {
    ...
    public function brgTerlarisBulan()
    {
        date_default_timezone_set('Asia/Jakarta');
        $bulan = date('m', time());
        $tahun = date('Y', time());

        $this->db->select('nama_b, SUM(jumlah) as terlaris');
        $this->db->from('tb_barang');
    ...
    {
        return $this->db->query("SELECT count(id_barang) as jumlah fROM tb_barang WHERE stok_b <= stok_min_b");
    }

    public function stockMinimum()
    {
        return $this->db->query("SELECT nama_b, stok_b, unit_b fROM tb_barang WHERE stok_b <= stok_min_b");
    }
